<?php 
    ...
    include "../mod_controller/update_modProfileCntrl.php" ;
                ...
                <div>
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td>: <input type="radio" name="usertype" value="Moderator" <?php if (isset($mod['usertype']) && $mod['usertype']=="Moderator") echo "checked";?>> Moderator
                            </td>
                        </tr>
                        <tr>
