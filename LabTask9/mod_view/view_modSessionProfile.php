        ...
        <section>
            ...
            <table>
                ...
                <tr>
                    ...
                    <td>: <span class="red font-size-20">***********</span><span><a href="../mod_view/update_modSessionPassword.php?user_id=<?php echo $mod['user_id'] ?>" class="green"> <i class="fas fa-lock"></i> Click to Change</a></span></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td><a href="../mod_view/update_modSessionProfile.php?user_id=<?php echo $mod['user_id'] ?>" class="green">EditProfile</a></td>
                    <td></td>
                    <td><a href="../mod_view/update_modSessionImage.php?user_id=<?php echo $mod['user_id'] ?>" class="green">Update Profile Image</a></td>
                </tr>
            </table>
        </section>
    </div>
