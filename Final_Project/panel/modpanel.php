...
<aside class="menu bottom-mar-500">
    <div class="font-size-30 m-l-10 pad-10">Moderator Account</div>
    <div class="top-mar-10 user-area">
        ...
        <a href="../mod_view/view_modSessionProfile.php?user_id=<?php echo $user_id ?>"><i class="fas fa-id-card"></i> View Profile</a> <br>
        <a href="../mod_view/update_modSessionProfile.php?user_id=<?php echo $user_id ?>"><i class="fas fa-user-edit"></i> Update Profile</a> <br>
        <a href="../mod_view/update_modSessionImage.php?user_id=<?php echo $user_id ?>"><i class="fas fa-camera-retro"></i> Change Profile Picture</a> <br>
        <a href="../mod_view/update_modSessionPassword.php?user_id=<?php echo $user_id ?>"> <i class="fas fa-key"></i> Change Password</a> <br>
    </div>
