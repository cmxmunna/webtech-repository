...
<body>
    <div class="header">
        ...
        <div class="header-right">
            <a href="view/profile.php"><i class="fas fa-key"></i>
                <?php
    ...
    <div class="heading">
        <ul>
            ...
            <li class="dropmenu"><a href="payment/payment.php"><i class="fa fa-credit-card"></i> Payment Options</a>
                <ul class="subdropmenu">
                    <li><a href="payment/bkash.php" target="_blank"><i class="fas fa-usd"></i> Bkash</a></li>
                    <li><a href="payment/nagad.php" target="_blank"><i class="fas fa-usd"></i> Nagad</a></li>
                    <li><a href="payment/rocket.php" target="_blank"><i class="fas fa-usd"></i> Rocket</a></li>
                    <li><a href="payment/mastercard.php" target="_blank"><i class="fab fa-cc-mastercard"></i> Mater
                            Card</a></li>
                    <li><a href="payment/visacard.php" target="_blank"><i class="fab fa-cc-visa"></i> Visa Card</a></li>
                    <li><a href="payment/banktransfer.php" target="_blank"><i class="fa fa-university"></i> Bank
                            Transfer</a></li>
                </ul>
            </li>
            ...
            <div class="row">
                ...
                <div class="footer-col">
                    ...
                    <div class="social-links">
                        <a href="aboutus/facebook.php"><i class="fab fa-facebook-f"></i></a>
                        <a href="aboutus/twtter.php"><i class="fab fa-twitter"></i></a>
                        <a href="aboutus/instagram.php"><i class="fab fa-instagram"></i></a>
                        <a href="aboutus/linkedin.php"><i class="fab fa-linkedin-in"></i></a>
                    </div>
                </div>
            </div>
        </div>
