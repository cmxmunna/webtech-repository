...
<div class="heading">
        <ul>
            ...
            <li class="dropmenu"><a href="../payment/payment.php"><i class="fa fa-credit-card"></i> Payment Options</a>
                <ul class="subdropmenu">
                    <li><a href="../payment/bkash.php"><i class="fa fa-usd"></i> Bkash</a></li>
                    <li><a href="../payment/nagad.php"><i class="fa fa-usd"></i> Nagad</a></li>
                    <li><a href="../payment/rocket.php"><i class="fa fa-usd"></i> Rocket</a></li>
                    <li><a href="../payment/mastercard.php"><i class="fab fa-cc-mastercard"></i> Mater Card</a></li>
                    <li><a href="../payment/visacard.php"><i class="fab fa-cc-visa"></i> Visa Card</a></li>
                    <li><a href="../payment/banktransfer.php"><i class="fa fa-university"></i> Bank Transfer</a></li>
                </ul>
            </li>
