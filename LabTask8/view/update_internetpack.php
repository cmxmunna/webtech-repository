...
<head>
    ...
    <title>Update Internet Pack</title>
</head>
<body>
    ...
    <?php include('../control/panelCntrl.php'); ?>
        <section>
            <h1 class="color-cyan">UPDATE INTERNET PACKAGE FROM LIST</h1>
                ...
                <tbody>
                    <?php foreach ($ipacks as $i => $ipack): ?>
                        <tr>
                            ...
                            <td>
                                <a href="../view/edit_ipack.php?id=<?php echo $ipack['id'] ?>" class="green"><span class="btn-action">&nbsp;&nbsp;Edit &nbsp;&nbsp;</span></a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
