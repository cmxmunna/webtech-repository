...
<head>
    ...
    <title>Delete Internet Pack</title>
</head>
<body>
    ...
    <?php include('../control/panelCntrl.php'); ?>
        <section>
            <h1 class="color-cyan">DELETE INTERNET PACKAGE FROM LIST</h1>
                ...
                <tbody>
                    <?php foreach ($ipacks as $i => $ipack): ?>
                        <tr>
                            ...
                            <td>
                                <a href="../control/delete_ipackCntrl.php?id=<?php echo $ipack['id'] ?>" onclick="return confirm('Are you sure want to delete this PACKAGE?')"><span class="btn-action error">Delete</span></a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
